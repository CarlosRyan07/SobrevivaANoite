...
|---|---|
| `menu-inicial-desktop.png` | abertura do jogo no computador |
...
| `historico-partidas.png` | estatísticas e partidas salvas |

As capturas devem mostrar a funcionalidade sem abas, notificações ou informações pessoais do computador. Cenas, nomes e artes dos finais não devem ser publicados, para preservar a descoberta pelo jogador.
